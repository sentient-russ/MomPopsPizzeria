...
public class registrationController extends MomPopPizzaMain  implements Initializable{

    @FXML
    private Label custLoginValidationText;
    @FXML
    private Button regHomeBtn;
    @FXML
    private Button regBackBtn;
    @FXML
    private Button regSaveBtn;
    @FXML
    ...
    boolean valid = checkFormIsValid(fName, lName, addr1, addr2, city, state, zip, phoneArea, phonePrefix, phonePostfix , password, confirmPassword);
    if(valid){
    ...
    @FXML
    protected void regCancelAction() {
        Stage stage = (Stage) regCancelBtn.getScene().getWindow();
        stage.close();
    }
    @FXML
    protected void regHomeAction() {
        Stage stage = (Stage) regHomeBtn.getScene().getWindow();
        stage.close();
    }
    @FXML
    protected void regBackAction() {
     ...
     */
    public boolean checkFormIsValid(String fNameIn, String lNameIn, String addr1In, String addr2In, String cityIn, String stateIn, String zipIn, String phoneAreaIn, String phonePrefixIn, String phonePostfixIn, String passwordIn, String confirmPasswordIn){
